...
// AESGCMEncryptor implements core.Encryptor using AES-256-GCM + Argon2id key derivation.
...
// Returns ErrDecryptionFailed on wrong password or tampered data — never raw crypto errors.
